<%-- 
    Document   : admin-alterar
    Created on : 15/09/2018, 17:43:51
    Author     : gustav0
--%>
            ...
            <!--MENU LATERAL FIM -->
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        <h1 class="h2">Alterar Local de Vacinação</h1>
                    ...
                    <div>
                        ...
                        <form method="post" action="">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Nome do Local" name="nome" value="${local.nome}">
                            </div>

                            <div class="form-group">
                                <label>Cidade</label>
                                <input type="text" class="form-control" placeholder="Cidade" name="cidade" value="${local.cidade}">
                            </div>

                            <div class="form-group">
                                <label>UF</label>
                                <input type="text" class="form-control" placeholder="UF" name="uf" value="${local.uf}">
                            </div>
