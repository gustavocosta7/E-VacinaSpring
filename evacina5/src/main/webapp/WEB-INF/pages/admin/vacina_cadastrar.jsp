<%-- 
    Document   : adm-vacinas-cadastrar
    Created on : 15/09/2018, 20:08:59
    Author     : gustav0
--%>
            ...
            <!--MENU LATERAL FIM -->
                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        <h1 class="h2">Cadastrar Vacina</h1>
                    ...
                    <div>
                        ...
                        <form method="post" action="">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Nome da Vacina" name="nome">
                            </div>

                            <div class="form-group">
                                <label>Descrição</label>
                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Descrição" name="descricao"></textarea>
                            </div>
