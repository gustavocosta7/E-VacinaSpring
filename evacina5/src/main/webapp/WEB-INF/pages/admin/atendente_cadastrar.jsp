<%-- 
    Document   : adm-usuario-cadastrar
    Created on : 15/09/2018, 19:59:03
    Author     : gustav0
--%>
                    ...
                    <div>
                        ...
                        <form method="post" action="">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Nome do Usuário" value="" required id="nome" name="nome">
                            </div>

                            <div class="form-group">
                                <label for="id">Matrícula</label>
                                <input type="text" name="id" required id="id" class="form-control" placeholder="Matrícula">
                            </div>

                            <div class="form-group">
                                <label>Senha</label>
                                <input name="senha" value="" type="password" class="form-control" placeholder="Senha">
                            </div>
